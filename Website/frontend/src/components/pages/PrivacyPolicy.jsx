      ...
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 relative z-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-5 bg-white/70 backdrop-blur-md p-6 sm:p-8 rounded-3xl border border-[#E8E1D5] shadow-xs">
          <div className="w-16 h-16 flex items-center justify-center shrink-0 drop-shadow-sm">
            <img src="./privacy-policy.webp" alt="Privacy Shield" className="w-full h-full object-contain" />
          </div>
          <div>
        ...
        <div className="space-y-4 text-xs sm:text-sm text-[#5C544D] leading-relaxed">
          ...
          <section className="group bg-white/70 hover:bg-white backdrop-blur-md border border-[#E8E1D5] hover:border-[#C05621]/60 rounded-3xl p-6 sm:p-7 space-y-2.5 shadow-xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            ...
            <h2 className="text-sm sm:text-base font-bold text-[#1A1A1A] flex items-center gap-2.5 group-hover:text-[#C05621] transition-colors">
              <div className="p-2 rounded-xl bg-[#F6F4F0] group-hover:bg-[#C05621]/10 text-[#C05621] transition-all duration-300 group-hover:scale-110">
